...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function displayBreeds(breeds) {
    ...
    breeds.forEach(breed => {
      ...
      <br /><i>Temperament:</i> ${breed.temperament}
      <br /><i>Weight:</i> ${breed.weight.metric} pounds
      <br /><i>Life Span:</i> ${breed.life_span}`;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function displayBreeds(breeds) {
    ...
    breeds.forEach(breed => {
      const listItem = document.createElement('li');
      listItem.classList.add('breed-item');
      listItem.innerHTML = `<strong>${breed.name}</strong>: ${breed.bred_for} 
        <br /><i>Temperament:</i> ${breed.temperament} 
        <br /><i>Height:</i> ${breed.height.metric} inches
        <br /><i>Weight:</i> ${breed.weight.metric} pounds
        <br /><i>Life Span:</i> ${breed.life_span}`;
      breedList.appendChild(listItem);
    });
